...
public class UpdateFeedetails extends javax.swing.JFrame {
 ...
 public String updateData(){
     ...
     PreparedStatement ps;
        ...
        String query = "update `feedetails` set studentname=?,paymentMode=?,checkNo=?,bankname=?,coursename=?,"
                +"regNo=?,totalamout=?,date=?,vat=?,edutax=?,totalinword=?,remark=?,year1=?,year2=?,rollno=?,amount=? where recieptNo=?";
     try{
         ps = Database.dbconnect().prepareStatement(query);
         
         ps.setString(1, studentname);
         ps.setString(2, paymentMode);
         ps.setString(3, checkNo);
         ...
         ps.setString(8,date);
         ps.setFloat(9, vat);
         ps.setFloat(10, edutax);
         ps.setString(11, totalinword);
         ps.setString(12, remark);
         ps.setInt(13,year1);
         ps.setInt(14, year2);
          ps.setString(15, rollno);
         ps.setFloat(16,amount);
         ps.setInt(17,recieptNo);
 ...
 public void setRecord(){
     ...
     try{
          ...
          rs = ps.executeQuery();
          rs.next();
          txt_receipts.setText(rs.getString("recieptNo"));
          comboPaymentMode.setSelectedItem(rs.getString("paymentMode"));
